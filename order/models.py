...
class OrderStatus(models.TextChoices):
    ...
    SHIPPED ='Shipped'
    DELIVRED ='Delivred'
class PaymanStatus(models.TextChoices):
    PAID ='Paid',
    UNPAID ='Unpaid'
class PaymanMode(models.TextChoices):
    COD ='COD',
    CARD ='CARD'
class Order(models.Model):
    ...
    paymant_status = models.CharField(max_length=30 ,choices=PaymanStatus.choices , default=PaymanStatus.UNPAID)
    paymant_mode = models.CharField(max_length=30 ,choices=PaymanMode.choices , default=PaymanMode.COD)
